...
public class UserAccountsController {
	...
	@PutMapping("/id/{id}")
	public ResponseEntity<?> updateUserAccounts(@PathVariable("id")final Long userId, @RequestBody @Valid final UserAccountsCreateRequest userAccountsCreateRequest){
